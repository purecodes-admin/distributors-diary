    ...
    <header>
        <div class="text-white bg-gray-900 py-5 px-10 md:flex md:items-center md:justify-between md:px-40">
            ...
            <div :class="open ? 'block' : 'hidden'" class="flex flex-col text-left md:block md:text-right mt-3 md:mt-0">
                <a href="/items/home" class="mt-3 md:mx-3 font-bold">Home</a>
                <a href="/customers" class="mt-3 md:mx-3  font-bold">Customers</a>
                ...
                <a href="/items" class="mt-3 md:mx-3  font-bold">Items</a>
                <a href="/inventories" class="mt-3 md:mx-3 font-bold">Inventory</a>
