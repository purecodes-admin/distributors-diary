...
<input type="hidden" id="csrf-token" value="{{ csrf_token() }}" />
     ...
     <input type="hidden" id="csrf-token" value="{{ csrf_token() }}" />
      ...
      <h1 class="text-4xl text-green-500 font-bold m-4">Purchasers List</h1>
         ...
         <th  class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Address</th>
         <th  class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Contact</th>
         ...
         <th class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Discription</th>
         ...
         <!-- <th  class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider col-span-2">Operations</th> -->
          ...
          <td style="overflow-wrap:anywhere;" class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ $record->discription }}</td>
        ...
        <td>
                 <a href="" class="ml-10"> 
                    <button class="bg-red-500  hover:bg-red-700 text-white font-bold px-2 rounded" onclick="deletePurchaser({{$record->id}})">Delete</button>
                 </a>
        </td>
          </tr>
          </tbody>
