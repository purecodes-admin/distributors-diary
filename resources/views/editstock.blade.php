      ...
      <h3 class="p-5 font-semibold text-lg underline text-green-500 hover:text-green-700">
        ...
        <a>Place Order</a>
            ...
            <div class="flex flex-col w-1/2">
              ...
              <select name="supplier_id" id="supplier_id" class=" ml-2 px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">
            ...
            <div class="flex flex-col w-1/2">
              ...
              <input type="text" value="{{old('quantity', $inventory->address)}}" name="quantity" class=" ml-2 px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Quantity">
            ...
            <div class="flex flex-col w-1/2">
              ...
              <input type="text" value="{{old('price', $inventory->price)}}" name="price" class=" ml-2 px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Enter Price">
            ...
            <button class="bg-green-500 hover:bg-green-700 font-bold text-white ml-2 py-2 rounded" type="submit">Update Record</button><br>
            </div>
